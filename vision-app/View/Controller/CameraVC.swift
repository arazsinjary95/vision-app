    ...
    func resultsMethod(request: VNRequest, error: Error?) {
        ...
        for classification in results {
            ...
            if classification.confidence < 0.5 {
                ...
                self.identifivationLbl.text = unknowObjectMessage
                ...
                self.identifivationLbl.text = identification
                self.confidenceLbl.text = "CONFIDENCE: \(confidence)%"
                let completeSentece = "This looks like a \(identification) and I'm \(confidence) precent sure."
                synthesizeSpeech(fromString: completeSentece)
                break
            }
        }
    }
    ...
    func photoOutput(_ output: AVCapturePhotoOutput, didFinishProcessingPhoto photo: AVCapturePhoto, error: Error?) {
        if let error = error {
            ...
            do {
                ...
                let handle = VNImageRequestHandler(data: photoData!)
